...
function scroll(){
    ...
    // Add sensitivity control here - lower values = slower scrolling
    const sensitivity = 0.6; // Adjust this value (0.1 to 1.0)
    
    if(reverse){
        target -= sensitivity; // Reduced from 1 to 0.5
    }else{
        target += sensitivity; // Reduced from 1 to 0.5
    }
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    startButton.addEventListener('click', () => {
        ...
        // After the fade-out animation, remove the overlay completely
        setTimeout(() => {
